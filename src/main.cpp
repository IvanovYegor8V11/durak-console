...
void fill_hand(std::vector<card>& hand_to_fill) {
    uint8_t difference = BASE_HAND_SIZE - hand_to_fill.size();
    uint8_t deck_size = deck.size();
    uint8_t count_new_cards = deck_size > difference ? difference : deck_size;
